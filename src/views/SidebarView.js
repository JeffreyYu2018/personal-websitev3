    ...
    return (
      <span>
        ...
        <span className="af-view">
          <div className="af-class-white-wrapper">{map(proxies['sidebar-profile-pic'], props => <img src="images/Cool_Profile_Pic.jpg" srcSet="images/Cool_Profile_Pic-p-500.jpeg 500w, images/Cool_Profile_Pic-p-800.jpeg 800w, images/Cool_Profile_Pic-p-1080.jpeg 1080w, images/Cool_Profile_Pic-p-2000.jpeg 2000w, images/Cool_Profile_Pic.jpg 2100w" sizes="(max-width: 767px) 100vw, (max-width: 991px) 97.296875px, 126px" alt {...{...props, className: `af-class-circle-profile ${props.className || ''}`}}>{props.children}</img>)}
